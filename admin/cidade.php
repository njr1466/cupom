...
function myFunction(id) {
	...
	if (answer){
		window.location = "lecidade.php?acao=deletar&codigo="+id+"";
	}
	else{
	...
	<?php 
		   ...
		   <tr>
					...
					<td class="text-center"><a class='btn btn-info btn-xs' href="editcidade.php?codigo=<?php echo $codigo;?>"><span class="glyphicon glyphicon-pencil"></span> Editar</a> <a href="#" class="btn btn-danger btn-xs" onclick="myFunction(<?php echo $codigo;?>)"><span class="glyphicon glyphicon-remove" ></span> Excluir</a></td>
				</tr>
			   <?php
								}
							?>
