                                            ...
                                            <table class="table table-striped custab">
                                                ...
                                                while ($row = mysqli_fetch_assoc($result)) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center"><a class='btn btn-info btn-xs' href="editoferta.php?codigo=<?php echo $codigo; ?>"><span class="glyphicon glyphicon-pencil"></span> Editar</a> <a href="#" class="btn btn-danger btn-xs" onclick="myFunction(<?php echo $codigo; ?>)"><span class="glyphicon glyphicon-remove" ></span> Excluir</a></td>
                                                    </tr>
                                                    <?php
                                                }
                                                ?>
